...
if [ "$my_runningPath" = "$my_mainPath" ]; then
    ...
    if [ -f "$my_startedJointDeconvolutionFile" ]; then
        ...
        if [[ -f "$my_croppingCheckFile" ]]; then
            ...
            #
            # Added in case the files have not been previously stored within the sub-directory "almagal"
            mv $my_mainPath/2019.1.00195.L/sources/ToModifySOURCE/images/combined/ToModifyTELESCOPE/combined-cont-fits.tar $my_mainPath/2019.1.00195.L/sources/ToModifySOURCE/images/combined/ToModifyTELESCOPE/almagal/.
            mv $my_mainPath/2019.1.00195.L/sources/ToModifySOURCE/images/combined/ToModifyTELESCOPE/auxiliary-cont-fits.tar $my_mainPath/2019.1.00195.L/sources/ToModifySOURCE/images/combined/ToModifyTELESCOPE/almagal/.
            #
        ...
        cp -rp $my_mainPath/2019.1.00195.L/sources/ToModifySOURCE/contsub/channelsForEachSPW_7M.txt $my_mainPath/2019.1.00195.L/sources/ToModifySOURCE/images/combined/ToModifyTELESCOPE/almagal/.
        cp -rp $my_mainPath/2019.1.00195.L/sources/ToModifySOURCE/contsub/channelsForEachSPW_TM2.txt $my_mainPath/2019.1.00195.L/sources/ToModifySOURCE/images/combined/ToModifyTELESCOPE/almagal/.
        cp -rp $my_mainPath/2019.1.00195.L/sources/ToModifySOURCE/contsub/channelsForEachSPW_TM1.txt $my_mainPath/2019.1.00195.L/sources/ToModifySOURCE/images/combined/ToModifyTELESCOPE/almagal/.
