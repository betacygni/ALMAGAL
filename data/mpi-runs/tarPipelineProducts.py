...
# Next step:       createIndividual_scriptForSelfCalibration.py
# 
...
#                   Only for 7M and TM2. The TM1 data is processed with
#                   the '_serial' scripts which already contain the
#                   tar commands of the products
# 
# Required:
