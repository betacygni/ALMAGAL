...
def my_functionJointDeconvolutionContinuum(my_telescope, my_source):
    ...
    ##########################################################################
    #
    # Phase 3: Add 7M mask and run TCLEAN task (auto-multithresh)
    #
    # Add original 7M mask
    #
    print("... ... Original 7M mask will be added")
    ...
    if os.path.isfile(my_outputImageNow + '_i' + str(itext) + '.mask.fits') == True:
        print("... ... Merging previous mask with 7M mask")
        os.system('rm -rf ' + str(my_runningPath) + '/almagal/processing/merged_with7M.mask')
        immath(imagename = [str(my_runningPath) + '/almagal/processing/7M.mask', str(my_runningPath) + '/almagal/' + my_outputImageNow + '_i' + str(itext) + '.mask'],
            mode = 'evalexpr',
            expr = '( IM0 + IM1 )',
            outfile = str(my_runningPath) + '/almagal/processing/merged_with7M.mask')
    else:
        print("... ... No previous mask, taking 7M mask directly")
        os.system('cp -rp ' + str(my_runningPath) + '/almagal/processing/7M.mask ' + str(my_runningPath) + '/almagal/processing/merged_with7M.mask')
    ...
    # First run of tclean after adding the 7M mask
    #
    # Define iteration name for output files
    #
    itext = my_iCounter(1)
    ...
    print("... Producing TCLEAN image - multiscale process, with 7M mask added (source " + str(my_source) + " step " + str(itext) + ")")
    print("... Some parameters are:")
    print("... ... pipeline threshold = " + str(my_threshold))
    print("... ... pipeline niter = " + str(my_niter))
    print("... ... used threshold = " + str(my_thresholdNow))
    ...
    while MOD_difference > 1.0 and dataResidual_MAD > 0.000075:
        ...
        print("... Producing TCLEAN image - continue multiscale to 4xrms_MAD, with 7M added (source " + str(my_source) + " step "+str(itext)+")")
        print("... Some parameters are:")
        print("... ... pipeline threshold = " + str(my_threshold))
        print("... ... pipeline niter = " + str(my_niter))
        print("... ... used threshold = " + str(my_thresholdNow))
    ...
    if (applyJvMfactor == True):
        ...
        os.system('tar -cf combined-cont-fits.tar *image*fits *mask*fits *model*fits *residual.fits *pb.fits *psf.fits')
        os.system('tar -cf auxiliary-cont-fits.tar tcleanParameters.txt casa*.log')
...
def my_functionJointDeconvolutionCubeFinal(function_spw, function_start, function_nchan, function_chunkName, my_imsize, my_cell, my_niter, my_threshold, my_pbmask, my_pblimit, my_weighting, my_robust, my_sidelobethreshold, my_noisethreshold, my_minbeamfrac, my_lownoisethreshold, my_negativethreshold, my_scales, my_outputImage, my_visfilestoclean):
    ...
    my_expectedRMSbroad = 2.0
    my_expectedRMSnarrow = 4.0
    ...
    if os.path.isfile(my_outputImageNow + '_i' + str(itext) + '.mask.fits') == True:
        ...
        immath(imagename = [str(my_runningPath) + '/almagal/processing/7M_spw' + str(function_spw) + '_chunk' + str(function_chunkName) + '.mask', str(my_runningPath) + '/almagal/' + my_outputImageNow + '_i' + str(itext) + '.mask'],
            mode = 'evalexpr',
            expr = '( IM0 + IM1 )',
            outfile = str(my_runningPath) + '/almagal/processing/merged_with7M_spw' + str(function_spw) + '_chunk' + str(function_chunkName) + '.mask')
    else:
        print("... ... No previous mask, taking 7M mask directly")
        os.system('cp -rp ' + str(my_runningPath) + '/almagal/processing/7M_spw' + str(function_spw) + '_chunk' + str(function_chunkName) + '.mask ' + str(my_runningPath) + '/almagal/processing/merged_with7M_spw' + str(function_spw) + '_chunk' + str(function_chunkName) + '.mask')
...
if(mystep in thesteps):
    ...
    if os.path.isdir(my_storagePath + '/2019.1.00195.L/sources/' + my_source + '/contsub'):
        print("HOLA")
        os.system('cp -rp ' + my_storagePath + '/2019.1.00195.L/sources/' + my_source + '/contsub/7M/perEB/*.tar ' + str(my_runningPath) + '/almagal/.')
        #os.system('cp -rp ' + my_storagePath + '/2019.1.00195.L/sources/' + my_source + '/contsub/TM2/perEB/*.tar ' + str(my_runningPath) + '/almagal/.')
        #os.system('cp -rp ' + my_storagePath + '/2019.1.00195.L/sources/' + my_source + '/contsub/TM1/perEB/*.tar ' + str(my_runningPath) + '/almagal/.')
        os.system('cp -rp ' + my_storagePath + '/2019.1.00195.L/sources/' + my_source + '/contsub/channelsForEachSPW* ' + str(my_runningPath) + '/almagal/.')
        os.system('ls -l ' + str(my_runningPath) + '/almagal/')
        my_firstLevelTMP = os.getcwd()
        os.chdir(str(my_runningPath)+'/almagal')
        my_sourceTarPaths, my_sourceTarDirs, my_sourceTarFiles = next(os.walk(str(my_runningPath) + '/almagal'))
        for my_sourceTarFile in my_sourceTarFiles:
            if (my_sourceTarFile[len(my_sourceTarFile)-4:] == '.tar'):
                os.system('tar -xf ' + my_sourceTarFile)
                os.system('rm -rf ' + my_sourceTarFile)
        os.system('rm -rf ' + str(my_runningPath) + '/almagal/processing/2019.1.00195.L/sources/' + my_source + '/calibrated')
        os.system('mkdir -p ' + str(my_runningPath) + '/almagal/processing/2019.1.00195.L')
        os.system('mkdir -p ' + str(my_runningPath) + '/almagal/processing/2019.1.00195.L/sources')
        os.system('mkdir -p ' + str(my_runningPath) + '/almagal/processing/2019.1.00195.L/sources/' + my_source)
        os.system('mv ' + str(my_runningPath) + '/almagal/2019.1.00195.L/sources/' + my_source + '/calibrated ' + str(my_runningPath) + '/almagal/processing/2019.1.00195.L/sources/' + my_source + '/.')
        os.system('rm -rf ' + str(my_runningPath) + '/almagal/2019.1.00195.L')
        #
        # Collect the pipeline information, just in case
        print("... collecting pipeline information")
...
if(mystep in thesteps):
    ...
    os.system('mv almagal/tcleanParameters.txt .')
